...
# Boas-vindas ao repositório do projeto Star Wars Planet Search!

Esse é um projeto de aprendizado React.js, desenvolvido durante minha formação na Trybe,
cujo objetivo é desenvolver uma lista com filtros de planetas do universo de Star Wars.
...
1. Clone o repositório
  * `git clone git@github.com:MikaelaBraga/starwars-planets-search.git`.
...
<details>
<summary>Clique para abrir lista de requisitos</summary>
...
---
>Obs: Esse é um projeto feito durante meu início de aprendizado em React.
